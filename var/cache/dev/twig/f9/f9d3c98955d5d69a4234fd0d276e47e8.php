...
class __TwigTemplate_37f554a13e35427b19a0990dd6b1a244 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        <tbody>
            <tr>
                ...
                <td>";
        // line 12
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["niveau"]) || array_key_exists("niveau", $context) ? $context["niveau"] : (function () { throw new RuntimeError('Variable "niveau" does not exist.', 12, $this->source); })()), "id", [], "any", false, false, false, 12), "html", null, true);
        yield "</td>
            </tr>
            <tr>
                <th>Nom</th>
                <td>";
        // line 16
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["niveau"]) || array_key_exists("niveau", $context) ? $context["niveau"] : (function () { throw new RuntimeError('Variable "niveau" does not exist.', 16, $this->source); })()), "nom", [], "any", false, false, false, 16), "html", null, true);
        yield "</td>
            </tr>
        </tbody>
    </table>
    ...
    ";
        // line 25
        yield Twig\Extension\CoreExtension::include($this->env, $context, "niveau/_delete_form.html.twig");
        yield "
";
...
{% block body %}
    ...
    <a href=\"{{ path('app_niveau_index') }}\">back to list</a>

    <a href=\"{{ path('app_niveau_edit', {'id': niveau.id}) }}\">edit</a>

    {{ include('niveau/_delete_form.html.twig') }}
{% endblock %}
", "niveau/show.html.twig", "C:\\Users\\Utilisateur\\Desktop\\folio 2\\templates\\niveau\\show.html.twig");
    }
}

...
class __TwigTemplate_707fef41ae6ae7c6e16feb2df3a14bda extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_formation_delete', {'id': formation.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ formation.id) }}\">
    <button class=\"btn\">Delete</button>
</form>
", "formation/_delete_form.html.twig", "C:\\Users\\Utilisateur\\Desktop\\folio 2\\templates\\formation\\_delete_form.html.twig");
    }
}

...
class __TwigTemplate_3e53897c16868f8d00ff2aaccb8de9a0 extends Template
{
    private $source;
    private $macros = [];
...
<html lang=\"en\">
    <head>
        ...
        ";
        // line 9
        $context["request_collector"] = ((array_key_exists("profile", $context)) ? (((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["profile"] ?? null), "collectors", [], "any", false, true, false, 9), "request", [], "any", true, true, false, 9)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["profile"] ?? null), "collectors", [], "any", false, true, false, 9), "request", [], "any", false, false, false, 9), null)) : (null))) : (null));
        // line 10
        yield "        ";
        $context["status_code"] = (( !(null === (isset($context["request_collector"]) || array_key_exists("request_collector", $context) ? $context["request_collector"] : (function () { throw new RuntimeError('Variable "request_collector" does not exist.', 10, $this->source); })()))) ? (((CoreExtension::getAttribute($this->env, $this->source, ($context["request_collector"] ?? null), "statuscode", [], "any", true, true, false, 10)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["request_collector"] ?? null), "statuscode", [], "any", false, false, false, 10), 0)) : (0))) : (0));
        // line 11
        yield "        ";
...
";
    ...
    {
        return array (  229 => 45,  218 => 22,  208 => 21,  194 => 17,  185 => 16,  175 => 15,  164 => 23,  162 => 21,  159 => 20,  156 => 15,  146 => 14,  126 => 7,  113 => 46,  111 => 45,  85 => 26,  81 => 24,  79 => 14,  73 => 12,  70 => 11,  67 => 10,  65 => 9,  60 => 7,  54 => 4,  49 => 1,);
    }
...
", "@WebProfiler/Profiler/base.html.twig", "C:\\Users\\Utilisateur\\Desktop\\folio 2\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Profiler\\base.html.twig");
    }
}

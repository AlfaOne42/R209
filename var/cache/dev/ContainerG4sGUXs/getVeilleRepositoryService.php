 ...
 */
class getVeilleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VeilleRepository' shared autowired service.
     *
     * @return \App\Repository\VeilleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VeilleRepository.php';

        return $container->privates['App\\Repository\\VeilleRepository'] = new \App\Repository\VeilleRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
